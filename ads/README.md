...
SEO 編・mos-kit 共通基盤の上に、広告編 v0.1 を **CLI + Web UI** として公開済み。`@start-x-work/mos-ads`（npm 0.1.2）として、診断・評価・ログ構造化に限定する。
...
With the SEO pillar and `@start-x-work/mos-kit` in place, Ads v0.1 is **live** as CLI + Web UI. npm `@start-x-work/mos-ads` 0.1.2 — diagnosis, evaluation, and structured decision logs only.
...
4. **Limited platform read access** — Yahoo! Ads via `platform yahoo` CLI + Web BYOK (read-only)

Repository: [marketing-os-ads](https://github.com/start-x-work/marketing-os-ads)  
Web UI: [marketing-os-ads.pages.dev](https://marketing-os-ads.pages.dev)  
Quickstart: [docs/QUICKSTART.md](https://github.com/start-x-work/marketing-os-ads/blob/main/docs/QUICKSTART.md)
